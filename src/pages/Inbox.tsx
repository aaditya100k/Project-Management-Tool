...
const Inbox = () => {
  return (
    <div className="bg-background text-on-background min-h-screen p-lg md:p-xl flex flex-col items-center justify-center">
      <span className="material-symbols-outlined text-[64px] text-primary mb-md">inbox</span>
      <h1 className="font-headline-lg text-headline-lg font-bold mb-sm">Your Inbox</h1>
      <p className="text-secondary font-body-md text-center max-w-md mb-lg">
        This is a placeholder for the Inbox page where you will receive your latest updates and direct messages.
      </p>
